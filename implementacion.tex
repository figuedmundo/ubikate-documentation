...
% \LTXtable{0.75\textwidth}{implementacion/requerimientos_no_funcionales}
  ...
  \label{sub:historias_de_usuario}
    ...
    % \input{planificacion/user_stories}
    \input{planificacion/us_table}
...
\input{planificacion/estimacion_user_stories}
