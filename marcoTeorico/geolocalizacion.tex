...
% \footnote{http://dle.rae.es/}
  ...
  \label{sub:definiciones}
    ...
    Estas definiciones estan desarrolladas en la especificaci\'on \textbf{Simple Feature Access}, la cual es mantenida por la OGC (Open Geospatial Consortium). Esta especificacion define el conjunto de tipos de datos (puntos, linea, poligono, etc) y las operaciones o metodos necesarios para manejar estos datos.
