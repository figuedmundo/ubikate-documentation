...
La resolución de este problema es la se analizará en este capítulo.
  ...
  \label{sec:teoria_grafos}
    ...
    \section{Representacion de un Grafo} % (fold)
    \label{sec:representacion_de_un_grafo}
      ...
      \label{sub:matriz_de_adyacencias_de_un_grafo}
        ...
        Cuando el grafo no es dirigido la matriz de adyacencias es simétrica, como en el grafo de la figura \ref{fig:grafo_ponderado}.
...
% !ht
    ...
    \section{El Problema de la ruta mas corta} % (fold)
    \label{sec:ruta_mas_corta}
      ...
      \subsection{Algoritmo de Dijkstra} % (fold)
...
% ********************************************************************
  ...
  % \label{sub:ruta_conclusion}
    ...
    solo se explicó el algoritmo de \emph{Dijkstra} por ser el que se esta usando en la aplicación desarrollada.\\
